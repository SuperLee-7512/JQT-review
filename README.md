...
|---|---|---|
| `weibull_complete_github_clean.R` | Reproduces the complete-sample Weibull simulation study. | Coverage probabilities and average interval lengths for shape, log scale, and log quantile. |
| `weibull_typeII_github_clean.R` | Reproduces the Type II right-censoring simulation study. | Coverage probabilities and average interval lengths under different numbers of observed failures. |
| `weibull_alt_github_clean.R` | Reproduces the accelerated life testing simulation study. | Coverage probabilities and average interval lengths for ALT regression parameters and use-stress quantiles. |
| `case_IT_github_clean.R` | Reproduces the fitted-model case-study simulation based on the insulating-fluid breakdown data. | Coverage summaries and interval-length boxplots for the use-stress log quantile. |
...
.
├── README.md
├── weibull_complete_github_clean.R
├── weibull_typeII_github_clean.R
├── weibull_alt_github_clean.R
└── case_IT_github_clean.R
```
...
```r
source("weibull_complete_github_clean.R")
source("weibull_typeII_github_clean.R")
source("weibull_alt_github_clean.R")
source("case_IT_github_clean.R")
```

From a terminal, the scripts can also be run with:

```bash
Rscript weibull_complete_github_clean.R
Rscript weibull_typeII_github_clean.R
Rscript weibull_alt_github_clean.R
Rscript case_IT_github_clean.R
```
